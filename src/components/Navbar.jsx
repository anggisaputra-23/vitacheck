        ...
        <div className="flex justify-between items-center h-24">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -inset-4 bg-gradient-to-r from-primary-300/0 via-primary-300/20 to-secondary-300/0 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500 group-hover:scale-150"></div>
              
              {/* Logo container */}
              <div className="relative bg-white/50 backdrop-blur-sm rounded-xl p-2 border border-white/30 group-hover:border-primary-300/50 transition-all duration-300">
                <img 
                  src="/vite%20logo.png" 
                  alt="VitaCheck" 
                  className="h-10 w-auto object-contain group-hover:scale-125 transition-transform duration-300"
                />
              </div>

              {/* Pulse ring on hover */}
              <div className="absolute -inset-6 border-2 border-primary-400 rounded-2xl opacity-0 group-hover:opacity-100 animate-pulse transition-opacity duration-300"></div>
            </div>
          </Link>
